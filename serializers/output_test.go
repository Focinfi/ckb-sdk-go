...
func TestNewOutputsDynVec(t *testing.T) {
	...
	tests := []struct {
		...
		},
		{
			...
			wantHex: "0x53000000080000004b0000000c0000001400000001000000000000003700000010000000300000003100000011111111111111111111111111111111111111111111111111111111111111110102000000abcd",
			wantErr: false,
		},
	}
